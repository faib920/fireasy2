...
{
    internal class ChineseSpellHash
    {
        internal static short[][] Table = new short[][] {
    ...
    internal class ChineseCodes
    {
        internal static string[] Table = new string[]{
            "a     :阿啊吖嗄腌锕",
    ...
    internal class ChineseSpellHelper
    {
        ...
        /// <returns></returns>
        internal static string GetPinyinFirstLetter(string str)
        {
            str = str.Trim();
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        internal static string GetPinyin(string str)
        {
        ...
        /// <returns></returns>
        internal static string GetChineseList(string pinyin)
        {
            var key = pinyin.Trim().ToLower();

            foreach (var str in ChineseCodes.Table)
            {
        ...
        private static string GetPinyin(char ch)
        {
            ...
            for (var i = 0; i < ChineseSpellHash.Table[hash].Length; ++i)
            {
                var index = ChineseSpellHash.Table[hash][i];
                var pos = ChineseCodes.Table[index].IndexOf(ch, 7);
                if (pos != -1)
                {
                    return ChineseCodes.Table[index].Substring(0, 6).Trim();
                }
            }
        ...
        {
            return (short)((uint)ch % ChineseCodes.Table.Length);
        }
    }
}
