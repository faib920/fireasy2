...
namespace Fireasy.Web.EasyUI
{
    public static class ComboGridExtensions
    {
        ...
        /// <returns></returns>
        public static ExtendHtmlString ComboGrid(this
#if !NETCOREAPP
            HtmlHelper htmlHelper
#else
            IHtmlHelper htmlHelper
#endif
            , string exp, ComboGridSettings settings = null)
        {
        ...
        /// <param name="settings">参数选项。</param>
        /// <returns></returns>
        public static ExtendHtmlString ComboGrid<TModel, TProperty>(this
#if !NETCOREAPP
            HtmlHelper<TModel> htmlHelper
#else
            IHtmlHelper<TModel> htmlHelper
#endif
            , Expression<Func<TModel, TProperty>> expression, ComboGridSettings settings = null)
        {
            settings = settings ?? new ComboGridSettings();
