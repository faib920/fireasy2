...
namespace Fireasy.Web.EasyUI
{
    public static class NumberSpinnerExtensions
    {
        ...
        /// <returns></returns>
        public static ExtendHtmlString NumberSpinner(this HtmlHelper htmlHelper, string exp, NumberSpinnerSettings settings = null)
        {
        ...
        /// <param name="settings">参数选项。</param>
        /// <returns></returns>
        public static ExtendHtmlString NumberSpinner<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, NumberSpinnerSettings settings = null)
        {
            settings = settings ?? new NumberSpinnerSettings();
