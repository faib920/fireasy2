...
namespace Fireasy.Data.Syntax
{
    ...
    public class PostgreSqlSyntax : ISyntaxProvider
    {
        ...
        {
            get { return strSyntax ?? (strSyntax = new PostgreSqlStringSyntax()); }
        }
        ...
        {
            get { return dtSyntax ?? (dtSyntax = new PostgreSqlDateTimeSyntax()); }
        }
        ...
        {
            get { return mathSyntax ?? (mathSyntax = new PostgreSqlMathSyntax()); }
        }
