            ...
            if (options.Provider == null && options.ConnectionString == null)
            {
                ...
                if (section != null)
                {
                    ...
                    if (setting != null)
                    {
                        ...
                        HandleConnectionStrings(setting, options);
                    }
                }
            }
        }

        protected void HandleConnectionStrings(IInstanceConfigurationSetting setting, EntityContextOptions options)
        {
            if (setting.Clusters.Count > 0)
            {
                ...
                options.DistributedConnectionStrings = connections;
            }
            else
            {
