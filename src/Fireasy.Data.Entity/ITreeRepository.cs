...
namespace Fireasy.Data.Entity
{
    ...
    public interface ITreeRepository
    {
        ...
        long Insert(IEntity entity, IEntity referEntity, EntityTreePosition position = EntityTreePosition.Children, Expression isolation = null);
        ...
        Task<long> InsertAsync(IEntity entity, IEntity referEntity, EntityTreePosition position = EntityTreePosition.Children, Expression isolation = null, CancellationToken cancellationToken = default);
    ...
    public interface ITreeRepository<TEntity> : ITreeRepository where TEntity : IEntity
    {
        ...
        /// <param name="position">插入的位置。</param>
        /// <param name="isolation">数据隔离表达式。</param>
        long Insert(TEntity entity, TEntity referEntity, EntityTreePosition position = EntityTreePosition.Children, Expression<Func<TEntity>> isolation = null);
        ...
        /// <param name="isolation">数据隔离表达式。</param>
        /// <param name="cancellationToken">取消操作的通知。</param>
        Task<long> InsertAsync(TEntity entity, TEntity referEntity, EntityTreePosition position = EntityTreePosition.Children, Expression<Func<TEntity>> isolation = null, CancellationToken cancellationToken = default);
