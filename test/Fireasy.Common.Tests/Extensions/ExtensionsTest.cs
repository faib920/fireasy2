...
namespace Fireasy.Common.Tests.Extensions
{
    ...
    public class ExtensionsTest
    {
        ...
        {
            var o = new Data1 { Name = "fireasy", Ext = new Data3 { OrgName = "old" } };
            var o1 = new Data2 { Ext = new Data3 { OrgId = 3 } };

            var o2 = o.MapTo(o1);
            Assert.AreEqual("fireasy", o2.Name);
            Assert.AreEqual(3, o2.Ext.OrgId);
            Assert.AreEqual("old", o2.Ext.OrgName);
        }

        [TestMethod]
        public void TestMapTo1()
        {
            var o = new { Name = "fireasy" };
            var o1 = new Data2();
        ...
        {
            dynamic o = new DynamicExpandoObject();
            var o1 = new Data2();

            o.Name = "fireasy";

            var o2 = GenericExtension.MapTo(o, o1);
            Assert.AreEqual("fireasy", o2.Name);
        }
