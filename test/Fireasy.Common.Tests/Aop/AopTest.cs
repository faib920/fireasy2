...
namespace Fireasy.Common.Tests
{
    ...
    public class AopTest
    {
        ...
        public void TestCalculate()
        {
            ...
            Console.WriteLine(proxy.Calculate(144d, 0d));
        }
        ...
        {
            [Intercept(typeof(SampleInterceptor1))]
            [Intercept(typeof(SampleInterceptor2))]
            ...
            [Intercept(typeof(SampleInterceptor), true)]
            ...
            [Intercept(typeof(AsyncInterceptor))]
            public virtual Task TestAsync1(string str)
            {
                Console.WriteLine("tt");
        ...
        public class SampleInterceptor1 : IInterceptor
        {
            ...
            {
                var target = info.Target as AopTest;
        ...
        {
            private List<MemberInfo> _initMarks = new List<MemberInfo>();
            private void aa_Initialize(List<IInterceptor> interceptors, InterceptCallInfo callInfo)
            {
