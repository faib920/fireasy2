...
studio");
        ...
        public void TestDeserializeObject()
        {
            ...
            var obj = serializer.Deserialize<JsonData>(
                new JsonText(@"{'name':'fireasy','birthday':'/Date(401299200000+0800)/','age':12,'WorkRecords':null,'time':'12:00:00'}").ToString()
                );
        ...
        [TestMethod]
        public void TestDeserializeObjectWithAnonymousType1()
        {
            var json = @"
{
  ""Name"": ""fireasy"",
  ...
  ""WorkRecords"": [
    ...
    },
    {
      ""Company"": ""book""
            ...
            var serializer = new JsonSerializer();
            var obj = serializer.Deserialize(json, new { Name = "", Age = 0, WorkRecords = new List<dynamic> { new { Company = "" } } });
  ...
  ""WorkRecords"": [
    ...
    },
    {
        ...
        [TestMethod()]
        public void TestDeserializeDynamicObject4()
        {
            var serializer = new JsonSerializer();
        ...
        [TestMethod()]
        public void TestDeserializeDynamicObject5()
        {
            var serializer = new JsonSerializer();

            var obj = serializer.Deserialize<List<dynamic>>(
                new JsonText(@"[{}]").ToString()
                );
