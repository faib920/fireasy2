...
namespace Fireasy.Data.Entity.Tests
{
    ...
    public class TranslationTests
    {
        ...
        {
            TestQuery(db.Products.Where(c => Convert.ToInt32(c.ProductID) == 44));
        }

        [TestMethod()]
        public void TestChangeType()
        {
            TestQuery(db.Products.Where(c => (int)Convert.ChangeType(c.ProductID, typeof(int)) == 44));
        }

        [TestMethod()]
        public void TestChangeType1()
        {
            TestQuery(db.Products.Where(c => (int)Convert.ChangeType(c.ProductID, TypeCode.Int32) == 44));
        }
        ...
        {
            TestQuery(from o in db.Products where o.ProductID > 20 select o);
        }

        [TestMethod()]
        public void TestSelectDelFlag3()
        {
            TestQuery(from o in db.OrderDetails where o.Products.ProductID > 20 select o);
        }
