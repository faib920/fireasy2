...
namespace Fireasy.Data.Entity.Tests
{
    ...
    public class DynamicTypeBuilderTests
    {
        ...
        public void TestBuild()
        {
            ...
            var empId = new GeneralProperty() { Name = "EmployeeId", Info = new PropertyMapInfo { ColumnName = "emp_id", IsPrimaryKey = true, GenerateType = IdentityGenerateType.AutoIncrement }, Type = typeof(int) };
            var empName = new GeneralProperty() { Name = "Name", Info = new PropertyMapInfo { ColumnName = "name" }, Type = typeof(string) };
            var empAge = new GeneralProperty() { Name = "Age", Info = new PropertyMapInfo { ColumnName = "age" }, Type = typeof(int?) };
            var empSex = new GeneralProperty() { Name = "Sex", Info = new PropertyMapInfo { ColumnName = "sex" }, Type = typeof(Sex) };
            ...
            var ordId = new GeneralProperty() { Name = "Id", Info = new PropertyMapInfo { ColumnName = "id", IsPrimaryKey = true, GenerateType = IdentityGenerateType.AutoIncrement }, Type = typeof(int) };
            var ordOrderDate = new GeneralProperty() { Name = "OrderDate", Info = new PropertyMapInfo { ColumnName = "order_date" }, Type = typeof(DateTime) };
            var ordEmpId = new GeneralProperty() { Name = "EmployeeId", Info = new PropertyMapInfo { ColumnName = "emp_id" }, Type = typeof(int?) };
